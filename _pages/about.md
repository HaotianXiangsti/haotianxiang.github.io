...
My research interests include **Generative Models**, **Intelligent Transportation Systems**, and **Active Learning**. I am passionate about training more Robust and more General models to survive from **Out-of-Distribution (OOD)** data which is most demanding obstacle in Real-World Scenarios. **( Long-Live AI4Science ! )**

I am the Transformer Generation !
======
As a Transformer Boomer, my research experience has been closely intertwined with the Transformer based models. From the inception of the Transformer Encoder to Visual Transformer (ViT), and further into the realms of Multimodal domain (ALBEF) and Spatial-Temporal Attention (ASTGCN), my work has revolved around exploring the applications of the Transformer model in various domains. I'd like to explore more possibilities of applying Transformer based model to tackle frontier issues.
